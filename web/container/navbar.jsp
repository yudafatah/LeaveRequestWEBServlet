        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Leave Request<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="Request.jsp">Employees Request</a>
                            </li>
                            <li>
                                <a href="Report.jsp">History Employees</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
...
<!--                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="Request.jsp">Manage Leave Request</a>
                            </li>
                            <li>
